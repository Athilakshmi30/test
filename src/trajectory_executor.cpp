    ...
    while (ros::ok())
    {
        ...
        if(trajectory_calculation_completed){
            ...
            if(sealer_exec){
                ...
                if (n.hasParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Sealer"))
                {n.getParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Sealer", speed_val);}    
                ...
                if (n.hasParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Base Coat 1"))
                {n.getParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Base Coat 1", speed_val);}  
                srv_sdur.request.speed = speed_val;
                send_data_ur_client.call(srv_sdur);
                ...
                if (n.hasParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Base Coat 2"))
                {n.getParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Base Coat 2", speed_val);}     
                srv_sdur.request.speed = speed_val;
                send_data_ur_client.call(srv_sdur);
                ...
                if (n.hasParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Clear Coat 1"))
                {n.getParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Clear Coat 1", speed_val);}    
                srv_sdur.request.speed = speed_val;
            ...
            if(trajectory_clear2.coat_feasibility && clear2_exec){
                ...
                if (n.hasParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Clear Coat 2"))
                {n.getParam("axalta/ccscore/dashboard/SPRAYGUN_TRAVERSE_SPEED_Clear Coat 2", speed_val);}       
                srv_sdur.request.speed = speed_val;
                send_data_ur_client.call(srv_sdur);
