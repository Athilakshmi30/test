...
bool handle_trajectory_planning_service(move_ur10e::JointSpaceTrajectoryService::Request &req,
                                        move_ur10e::JointSpaceTrajectoryService::Response &res)
{
...
{ // 2.25 0.02
  ...
  while ((fraction * 100.0) < 100.0 && tries<3)
  {
    ...
    tries++;
    if (tries >0){
        ros::param::set("record_vid", "start");      
    }
  }
  ros::param::set("record_vid", "end");
  if (fraction == 1.0)
  {
