...
class SpraygunHandler():
    ...
    def update_yaml(self, data):
        ...
        with open("/home/axalta/axalta_ws/src/dashboard/config/dashboard_persistent_settings.yaml", 'r+') as file:
            ...
            file.truncate()
        with open("/home/axalta/axalta_ws/src/dashboard/config/dashboard_persistent_settings.yaml", 'a') as file:
