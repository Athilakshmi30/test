...
def reconstructedCallBack(msg):
    ...
    rgb_value = [121,117,116]
    #rgb_value = [127,0,254]
    #rgb_value = [28,158,156]
    I_value=getIfromRGB(rgb_value)
    print("Int_value_from_rdb:")
    print(I_value)
    ...
    for data in pc2:
        ...
        if (data[3] >= 10600000 and data[3] <= 18000000) and z <1.3: #1873816 #if (data[3] >= 10700000 and data[3] <= 25000000) and z <1.3:
