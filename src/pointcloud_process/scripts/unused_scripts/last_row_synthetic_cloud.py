...
class SyntheticCloud():
    ...
    def createGrid(self, cloud):
        ...
        return gridded_cloud, boolean_grid, gridded_cloud_linear, synthetic_cloud_linear
    ...
    def last_row_from_path(self,path_list , boolean_grid):#, gridded_cloud_list, synthetic_cloud_list):
        print("path_list",path_list)
        last_path_list = []  
        for plane in path_list:
            new_row = []
            last_path_list.append(plane[-1])       
        print("last_path_list", last_path_list) 
        return last_path_list
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            if(self.received and not self.processed):
                ...
                _, boolean_grid, gridded_cloud_list, synthetic_cloud_list = self.createGrid(
                ...
                path_reordered_list_all =self.last_row_from_path(path_list , boolean_grid)
